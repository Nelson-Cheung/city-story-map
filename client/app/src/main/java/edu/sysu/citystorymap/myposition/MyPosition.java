package edu.sysu.citystorymap.myposition;
...
public class MyPosition implements BaseJson {
    ...
    public JSONObject toJSONObject() {
        ...
        ans.put("myLatitude", myLatitude);
        ans.put("myLongitude", myLongitude);
        ans.put("latitude", latitude);
        ans.put("longitude", longitude);
        return ans;
    }
