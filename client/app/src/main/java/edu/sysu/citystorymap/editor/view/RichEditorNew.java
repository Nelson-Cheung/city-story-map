package edu.sysu.citystorymap.editor.view;
...
import edu.sysu.citystorymap.editor.common.CommonJs;
import edu.sysu.citystorymap.editor.common.FilesUtils;
import edu.sysu.citystorymap.editor.common.Utils;

import static edu.sysu.citystorymap.editor.common.FilesUtils.getVideoThumbnail;
...
public class RichEditorNew extends RichEditor {
    ...
    public void loadRichEditorCode(String html) {
        loadDataWithBaseURL("file:///android_asset/",
                "<body style=\"word-wrap:break-word;\"> </body>" + html + CommonJs.IMG_CLICK_JS, "text/html", "utf-8", null);
    }
